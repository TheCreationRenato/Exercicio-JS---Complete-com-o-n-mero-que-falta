...
function soltou(e) {
    if (e.key === 'Enter') {
        ...
        if(newRandomNumbers.includes(lastDivH2)){
    console.log('kiwi é um item do array');
    }else{
        console.log('não existe kiwi no array');
    }*/
        
    
    //console.log(lastDivH2);
   console.log (newRandomNumbers);
...
const quest = document.querySelector('#quest_inp');
            let contFormat = quest.value;
            contFormat = parseInt(contFormat);
            

//console.log(contFormat);
